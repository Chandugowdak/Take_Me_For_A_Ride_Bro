...
const { sendRequest, getPendingRequests, updateRequestStatus,getUserPendingRequests ,cancelRequest ,getEarnerEarnings , getUserAllRequests , getAllEarnerRequests } = require('../controllers/Request');
...
requestrout.get('/req/user', Verify_User, getUserPendingRequests );
...
requestrout.get('/req/user/history' , Verify_User, getUserAllRequests);
