...
const My_Requests = () => {
  ...
  const fetchRequests = async () => {
    try {
      const res = await axios.get("http://localhost:3000/api/req/pending", {
        headers: {
        ...
        <div className="row g-4">
          {requests.length === 0 ? (
            ...
            requests.map((req) => {
              ...
              return (
                <div key={req._id} className="col-xl-4 col-lg-6 col-md-6">
                  <div className="request-card-new animate-card">
                    ...
                    <div className="request-details">
                      ...
                      <p>
                        ...
                        <strong>{req.userId?.phone}</strong>
                      </p>

                      <p>
                        <FaClock /> Duration: <strong>{req.numberOfDays} Days</strong>
                      </p>
                      <p>
                        <FaMoneyBill /> Total Price:{" "}
                        <strong>{req.totalAmount} Rs</strong>
                      </p>
                    </div>
